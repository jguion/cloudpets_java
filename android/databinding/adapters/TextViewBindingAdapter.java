...
public class TextViewBindingAdapter {
    ...
    public static void setListener(TextView view, BeforeTextChanged before, AfterTextChanged after) {
        setListener(view, before, null, after);
    }

    @BindingAdapter({"android:beforeTextChanged", "android:onTextChanged"})
    public static void setListener(TextView view, BeforeTextChanged before, OnTextChanged on) {
        setListener(view, before, on, null);
    }

    @BindingAdapter({"android:onTextChanged", "android:afterTextChanged"})
    public static void setListener(TextView view, OnTextChanged on, AfterTextChanged after) {
        setListener(view, null, on, after);
    }

    @BindingAdapter({"android:beforeTextChanged", "android:onTextChanged", "android:afterTextChanged"})
    public static void setListener(TextView view, final BeforeTextChanged before, final OnTextChanged on, final AfterTextChanged after) {
