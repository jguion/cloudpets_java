...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    public AutoScrollHelper(View target) {
        ...
        setRampUpDuration(SelectBluetoothToyFragment.HEART_BLINK_INTERVAL_MILLISECONDS);
        setRampDownDuration(SelectBluetoothToyFragment.HEART_BLINK_INTERVAL_MILLISECONDS);
    }
