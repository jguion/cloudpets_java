...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1) {
                int majorGravity = this.mGravity & ParseException.INVALID_CHANNEL_NAME;
                if (majorGravity != 48) {
                    switch (majorGravity) {
                        case 16:
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & ParseException.INVALID_CHANNEL_NAME) >> 4) & -2) >> 1;
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i2 & ParseException.INVALID_CHANNEL_NAME) >> 4) & -2) >> 1;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & ParseException.INVALID_CHANNEL_NAME;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & ParseException.INVALID_CHANNEL_NAME) {
                    case 16:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & ParseException.INVALID_CHANNEL_NAME) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & ParseException.INVALID_CHANNEL_NAME;
        if ((this.mGravity & ParseException.INVALID_CHANNEL_NAME) != gravity) {
