...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        for (i = 0; i < count; i++) {
            ...
            int spec = MeasureSpec.makeMeasureSpec(this.mCachedBorders[lp.mSpanIndex + lp.mSpanSize] - this.mCachedBorders[lp.mSpanIndex], Ints.MAX_POWER_OF_TWO);
            if (this.mOrientation == 1) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view) != maxSize) {
                ...
                spec = MeasureSpec.makeMeasureSpec(this.mCachedBorders[lp.mSpanIndex + lp.mSpanSize] - this.mCachedBorders[lp.mSpanIndex], Ints.MAX_POWER_OF_TWO);
                if (this.mOrientation == 1) {
