...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private JSONObject zzahi() {
        ...
        try {
            ...
            if (getDisplayName() != null) {
                jSONObject.put(Profile.DISPLAY_NAME, getDisplayName());
            }
    ...
    public static GoogleSignInAccount zzfw(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString("id"), jSONObject.optString("tokenId", null), jSONObject.optString("email", null), jSONObject.optString(Profile.DISPLAY_NAME, null), jSONObject.optString("givenName", null), jSONObject.optString("familyName", null), parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzfx(jSONObject.optString("serverAuthCode", null));
    }
