...
public abstract class zzg {
    ...
    public static final zzg BD = zza('\u0000', Ascii.MAX);
    ...
    public static final zzg BL = zza('\u0000', '\u001f').zza(zza(Ascii.MAX, ''));
    public static final zzg BM = zza('\u0000', ' ').zza(zza(Ascii.MAX, ' ')).zza(zzc('­')).zza(zza('؀', '؃')).zza(zza((CharSequence) "۝܏ ឴឵᠎")).zza(zza(' ', '‏')).zza(zza(' ', ' ')).zza(zza(' ', '⁤')).zza(zza('⁪', '⁯')).zza(zzc('　')).zza(zza('?', '')).zza(zza((CharSequence) "﻿￹￺￻"));
