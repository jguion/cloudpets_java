...
public class zze {
    ...
    public static boolean zzapl() {
        return VoiceMessage.USER.equals(Build.TYPE);
    }
    ...
    public static boolean zzbw(Context context) {
        if (zzs.zzaxq()) {
            Bundle applicationRestrictions = ((UserManager) context.getSystemService(VoiceMessage.USER)).getApplicationRestrictions(context.getPackageName());
