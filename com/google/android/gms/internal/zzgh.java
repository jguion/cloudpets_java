...
public final class zzgh {
    ...
    public zzgh(String str) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            zzgg com_google_android_gms_internal_zzgg = new zzgg(jSONArray.getJSONObject(i2));
            arrayList.add(com_google_android_gms_internal_zzgg);
            if (i < 0 && zza(com_google_android_gms_internal_zzgg)) {
                i = i2;
            }
        }
        this.zzbsp = i;
    ...
    private boolean zza(zzgg com_google_android_gms_internal_zzgg) {
        for (String equals : com_google_android_gms_internal_zzgg.zzbrn) {
