...
public final class zzjh {
    ...
    public static final class zza {
        ...
        public zza(Context context, zzjh com_google_android_gms_internal_zzjh) {
            PackageManager packageManager = context.getPackageManager();
            zzv(context);
            zza(context, packageManager);
            zzw(context);
            zzx(context);
            this.zzcls = com_google_android_gms_internal_zzjh.zzcls;
            this.zzclt = com_google_android_gms_internal_zzjh.zzclt;
            this.zzclv = com_google_android_gms_internal_zzjh.zzclv;
            this.zzclw = com_google_android_gms_internal_zzjh.zzclw;
            this.zzclx = com_google_android_gms_internal_zzjh.zzclx;
            this.zzcma = com_google_android_gms_internal_zzjh.zzcma;
            this.zzcmb = com_google_android_gms_internal_zzjh.zzcmb;
            this.zzcgg = com_google_android_gms_internal_zzjh.zzcgg;
            this.zzcge = com_google_android_gms_internal_zzjh.zzcge;
            this.zzcgf = com_google_android_gms_internal_zzjh.zzcgf;
        }
        ...
        private void zzw(Context context) {
            ...
            if (registerReceiver != null) {
                ...
                this.zzcmi = (double) (((float) registerReceiver.getIntExtra(Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
