...
public final class zzhe {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] zzbuj = new int[Gender.values().length];

        static {
            zzbuk = new int[ErrorCode.values().length];
            try {
                zzbuk[ErrorCode.INTERNAL_ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                zzbuk[ErrorCode.INVALID_REQUEST.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                zzbuk[ErrorCode.NETWORK_ERROR.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                zzbuk[ErrorCode.NO_FILL.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                zzbuj[Gender.FEMALE.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                zzbuj[Gender.MALE.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                zzbuj[Gender.UNKNOWN.ordinal()] = 3;
    ...
    public static Gender zzad(int i) {
        switch (i) {
            case 1:
                return Gender.MALE;
            case 2:
