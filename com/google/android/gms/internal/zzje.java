...
public final class zzje {
    ...
    private void zzak(Map<String, List<String>> map) {
        ...
        if (zzd == null || TextUtils.isEmpty(zzd)) {
            ...
            boolean booleanValue = ((Boolean) zzdi.zzbaw.get()).booleanValue();
            ...
            this.zzclb = new AutoClickProtectionConfigurationParcel(booleanValue, Arrays.asList(strArr));
            return;
        }
        try {
    ...
    private void zzal(Map<String, List<String>> map) {
        this.zzcld = zzd(map, HttpHeaders.SET_COOKIE);
    }
    ...
    private void zzam(Map<String, List<String>> map) {
        ...
        if (!TextUtils.isEmpty(zzd)) {
            try {
                ...
                zzb.zzd("Error parsing safe browsing header", e);
            }
        }
    }
    ...
    static long zze(Map<String, List<String>> map, String str) {
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            try {
                ...
                zzb.zzdf(new StringBuilder((String.valueOf(str).length() + 36) + String.valueOf(str2).length()).append("Could not parse float from ").append(str).append(" header: ").append(str2).toString());
            }
        }
        return -1;
    }
