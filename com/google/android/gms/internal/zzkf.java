...
public class zzkf {
    ...
    public zzkf(zzkh com_google_android_gms_internal_zzkh, String str, String str2) {
        ...
        this.zzcox = -1;
        this.zzcoy = -1;
        this.zzapw = com_google_android_gms_internal_zzkh;
        this.zzcor = str;
        this.zzcos = str2;
    ...
    public void zzta() {
        synchronized (this.zzakd) {
            if (this.zzcoy != -1) {
                zza com_google_android_gms_internal_zzkf_zza = new zza();
                com_google_android_gms_internal_zzkf_zza.zzte();
                this.zzcoq.add(com_google_android_gms_internal_zzkf_zza);
                this.zzcow++;
    ...
    public void zztb() {
        synchronized (this.zzakd) {
            if (!(this.zzcoy == -1 || this.zzcoq.isEmpty())) {
                zza com_google_android_gms_internal_zzkf_zza = (zza) this.zzcoq.getLast();
                if (com_google_android_gms_internal_zzkf_zza.zztc() == -1) {
                    com_google_android_gms_internal_zzkf_zza.zztd();
                    this.zzapw.zza(this);
                }
            }
        }
