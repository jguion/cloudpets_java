...
public final class zzhb implements NativeMediationAdRequest {
    ...
    public NativeAdOptions getNativeAdOptions() {
        ...
        Builder requestMultipleImages = new Builder().setReturnUrlsForImageAssets(this.zzand.zzblb).setImageOrientation(this.zzand.zzblc).setRequestMultipleImages(this.zzand.zzbld);
