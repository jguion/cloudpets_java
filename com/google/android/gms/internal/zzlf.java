...
public final class zzlf {
    ...
    private OnGlobalLayoutListener zzcth;
    private OnScrollChangedListener zzcti;

    public zzlf(Activity activity, View view, OnGlobalLayoutListener onGlobalLayoutListener, OnScrollChangedListener onScrollChangedListener) {
        this.zzctd = activity;
        this.mView = view;
