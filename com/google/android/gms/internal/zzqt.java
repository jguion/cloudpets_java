...
public class zzqt implements Callback {
    ...
    private class zzc<O extends ApiOptions> implements ConnectionCallbacks, OnConnectionFailedListener, zzqg {
        ...
        L_0x001d:
            return;
        L_0x001e:
            r1 = com.google.android.gms.internal.zzqt.zzaok;
            monitor-enter(r1);
            r2 = r5.yE;	 Catch:{ all -> 0x0044 }
            r2 = null;	 Catch:{ all -> 0x0044 }
            if (r2 == 0) goto L_0x0047;
        L_0x002b:
            r2 = r5.yE;	 Catch:{ all -> 0x0044 }
            r2 = r2.yA;	 Catch:{ all -> 0x0044 }
            r3 = r5.vx;	 Catch:{ all -> 0x0044 }
    ...
    private zzqt(Context context, GoogleApiAvailability googleApiAvailability) {
        this.xT = Constants.ACTIVE_THREAD_WATCHDOG;
        this.xS = 120000;
        this.yt = 10000;
        this.yv = -1;
