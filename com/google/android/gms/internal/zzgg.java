...
public final class zzgg {
    ...
    public zzgg(JSONObject jSONObject) throws JSONException {
        ...
        this.zzbro = jSONObject.optString("allocation_id", null);
        ...
        this.zzbrw = jSONObject.optString("html_template", null);
        this.zzbrx = jSONObject.optString("ad_base_url", null);
        optJSONObject = jSONObject.optJSONObject("assets");
        this.zzbry = optJSONObject != null ? optJSONObject.toString() : null;
