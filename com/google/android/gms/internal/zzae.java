...
public interface zzae {
    ...
    public static final class zza extends zzare<zza> {
        ...
        public void zza(zzard com_google_android_gms_internal_zzard) throws IOException {
            ...
            if (this.zzex != null) {
                com_google_android_gms_internal_zzard.zza((int) ParseException.PASSWORD_MISSING, this.zzex);
            }
            super.zza(com_google_android_gms_internal_zzard);
        }
        ...
        protected int zzx() {
            ...
            return this.zzex != null ? zzx + zzard.zzc((int) ParseException.PASSWORD_MISSING, this.zzex) : zzx;
        }
    }
