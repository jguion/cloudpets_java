...
public class zzau {
    private static final String[] zzahb = new String[]{"/aclk", "/pcs/click"};
    private String zzagx = "googleads.g.doubleclick.net";
    private String zzagy = "/pagead/ads";
    private String zzagz = "ad.doubleclick.net";
    private String[] zzaha = new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};
    private zzap zzahc;

    public zzau(zzap com_google_android_gms_internal_zzap) {
        this.zzahc = com_google_android_gms_internal_zzap;
    }
