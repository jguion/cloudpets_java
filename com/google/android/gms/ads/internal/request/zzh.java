...
public class zzh implements Creator<AdResponseParcel> {
    static void zza(AdResponseParcel adResponseParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 28, adResponseParcel.zzcho, i, false);
        ...
        zzb.zza(parcel, 33, adResponseParcel.zzchr, i, false);
        ...
        zzb.zza(parcel, 37, adResponseParcel.zzchv, i, false);
        ...
        zzb.zza(parcel, 44, adResponseParcel.zzchx, i, false);
    ...
    public AdResponseParcel[] zzar(int i) {
        ...
        while (parcel.dataPosition() < zzcq) {
            ...
            switch (zza.zzgv(zzcp)) {
                ...
                case 32:
                    ...
                    break;
                case 33:
                    rewardItemParcel = (RewardItemParcel) zza.zza(parcel, zzcp, (Creator) RewardItemParcel.CREATOR);
                    break;
                case 34:
                    list4 = zza.zzae(parcel, zzcp);
                    break;
                case 35:
                    list5 = zza.zzae(parcel, zzcp);
                    break;
                case 36:
                    z10 = zza.zzc(parcel, zzcp);
                    break;
                case 37:
                    autoClickProtectionConfigurationParcel = (AutoClickProtectionConfigurationParcel) zza.zza(parcel, zzcp, (Creator) AutoClickProtectionConfigurationParcel.CREATOR);
                    break;
                case 38:
                ...
                case 43:
                    ...
                    break;
                case 44:
                    safeBrowsingConfigParcel = (SafeBrowsingConfigParcel) zza.zza(parcel, zzcp, (Creator) SafeBrowsingConfigParcel.CREATOR);
                    break;
                case 45:
