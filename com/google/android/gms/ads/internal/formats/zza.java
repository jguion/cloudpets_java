...
@zziy
public class zza {
    private static final int zzbjc = Color.rgb(12, 174, ParseException.SESSION_MISSING);
    private static final int zzbjd = Color.rgb(ParseException.EMAIL_MISSING, ParseException.EMAIL_MISSING, ParseException.EMAIL_MISSING);
