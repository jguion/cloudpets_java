...
public final class zzv implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    @Nullable
    public zzke zzara;
    public com.google.android.gms.internal.zzke.zza zzarb;
    @Nullable
    public zzkf zzarc;
    @Nullable
    zzp zzard;
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void removeAllViews() {
            List<zzlt> arrayList = new ArrayList();
    ...
    zzv(Context context, AdSizeParcel adSizeParcel, String str, VersionInfoParcel versionInfoParcel, zzau com_google_android_gms_internal_zzau) {
        this.zzart = null;
        this.zzaru = null;
        this.zzarv = 0;
        this.zzarw = false;
        ...
        if (com_google_android_gms_internal_zzau == null) {
            com_google_android_gms_internal_zzau = new zzau(new zzi(this));
        }
        this.zzaqu = com_google_android_gms_internal_zzau;
    ...
    private void zzhf() {
        if (this.zzaqw != null) {
            View findViewById = this.zzaqw.getRootView().findViewById(16908290);
