...
public class zzf implements Creator<AdOverlayInfoParcel> {
    static void zza(AdOverlayInfoParcel adOverlayInfoParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, adOverlayInfoParcel.zzbye, i, false);
        ...
        zzb.zza(parcel, 14, adOverlayInfoParcel.zzaqv, i, false);
        zzb.zza(parcel, 15, adOverlayInfoParcel.zzpg(), false);
        zzb.zza(parcel, 16, adOverlayInfoParcel.zzbyp, false);
        zzb.zza(parcel, 17, adOverlayInfoParcel.zzbyq, i, false);
    ...
    public AdOverlayInfoParcel[] zzai(int i) {
        ...
        while (parcel.dataPosition() < zzcq) {
            ...
            switch (zza.zzgv(zzcp)) {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    versionInfoParcel = (VersionInfoParcel) zza.zza(parcel, zzcp, (Creator) VersionInfoParcel.CREATOR);
                    break;
                case 15:
                ...
                case 16:
                    ...
                    break;
                case 17:
                    interstitialAdParameterParcel = (InterstitialAdParameterParcel) zza.zza(parcel, zzcp, (Creator) InterstitialAdParameterParcel.CREATOR);
                    break;
                default:
                    zza.zzb(parcel, zzcp);
                    break;
