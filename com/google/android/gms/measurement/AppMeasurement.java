...
public class AppMeasurement {
    ...
    public static final class zze extends UserProperty {
        public static final Map<String, String> ant = zzf.zzb(new String[]{"firebase_last_notification", "first_open_time", "last_deep_link_referrer", "user_id"}, new String[]{"_ln", "_fot", "_ldl", APEZProvider.FILEID});
    }
    ...
    public void setUserId(String str) {
        zzb("app", APEZProvider.FILEID, str);
    }
