...
public final class zzl {
    ...
    public static zza<Integer> aoN = zza.zzab("measurement.upload.max_events_per_bundle", Constants.MAX_DOWNLOADS);
    public static zza<Integer> aoO = zza.zzab("measurement.upload.max_events_per_day", 100000);
    public static zza<Integer> aoP = zza.zzab("measurement.upload.max_error_events_per_day", Constants.MAX_DOWNLOADS);
    public static zza<Integer> aoQ = zza.zzab("measurement.upload.max_public_events_per_day", 50000);
    public static zza<Integer> aoR = zza.zzab("measurement.upload.max_conversions_per_day", SelectBluetoothToyFragment.HEART_BLINK_INTERVAL_MILLISECONDS);
    ...
    public static zza<Long> apa = zza.zzh("measurement.alarm_manager.minimum_interval", Constants.WATCHDOG_WAKE_TIMER);
    ...
    public static zza<Long> api = zza.zzh("measurement.service_client.idle_disconnect_millis", Constants.ACTIVE_THREAD_WATCHDOG);
