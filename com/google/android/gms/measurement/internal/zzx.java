...
public class zzx {
    ...
    private void zza(int i, Throwable th, byte[] bArr) {
        ...
        this.arm = null;
        if ((i == 200 || i == ParseException.EMAIL_MISSING) && th == null) {
    ...
    void zzb(String str, int i, Throwable th, byte[] bArr, Map<String, List<String>> map) {
        ...
        try {
            zza zzlz = zzbvb().zzlz(str);
            int i3 = ((i == 200 || i == ParseException.EMAIL_MISSING || i == 304) && th == null) ? 1 : 0;
            if (zzlz == null) {
                    ...
                    if (zzlz != null) {
                        ...
                        try {
                            ...
                            if (!(zzmp == null || TextUtils.isEmpty(zzmq))) {
                                map = new ArrayMap();
                                map.put(HttpHeaders.IF_MODIFIED_SINCE, zzmq);
                            }
