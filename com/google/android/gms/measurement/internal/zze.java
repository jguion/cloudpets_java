...
class zze extends zzaa {
    ...
    private class zzc extends SQLiteOpenHelper {
        ...
        private boolean zza(SQLiteDatabase sQLiteDatabase, String str) {
            ...
            try {
                ...
                query = sQLiteDatabase2.query("SQLITE_MASTER", new String[]{FriendRecord.NAME}, "name=?", new String[]{str}, null, null, null);
                try {
    ...
    public void zza(zzh com_google_android_gms_measurement_internal_zzh, long j, boolean z) {
        ...
        try {
            ...
            contentValues.put(FriendRecord.NAME, com_google_android_gms_measurement_internal_zzh.mName);
    ...
    public void zza(zzi com_google_android_gms_measurement_internal_zzi) {
        ...
        contentValues.put(FriendRecord.NAME, com_google_android_gms_measurement_internal_zzi.mName);
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    try {
                        ...
                        cursor2 = writableDatabase.query("raw_events", new String[]{"rowid", FriendRecord.NAME, "timestamp", "data"}, "app_id=? and metadata_fingerprint=?", new String[]{string, str2}, null, null, "rowid", null);
                        if (cursor2.moveToFirst()) {
                            do {
    ...
    public boolean zza(zzak com_google_android_gms_measurement_internal_zzak) {
        ...
        contentValues.put(FriendRecord.NAME, com_google_android_gms_measurement_internal_zzak.mName);
    ...
    boolean zzc(String str, List<Integer> list) {
        ...
        try {
            ...
            return writableDatabase.delete("audience_filter_values", new StringBuilder(String.valueOf(valueOf).length() + ParseException.EXCEEDED_QUOTA).append("audience_id in (select audience_id from audience_filter_values where app_id=? and audience_id not in ").append(valueOf).append(" order by rowid desc limit -1 offset ?)").toString(), new String[]{str, Integer.toString(r5)}) > 0;
        } catch (SQLiteException e) {
            zzbvg().zzbwc().zzj("Database error querying filters", e);
            return false;
        }
    ...
    public List<zzak> zzly(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{FriendRecord.NAME, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzbvi().zzbty()));
            try {
                if (query.moveToFirst()) {
                    do {
