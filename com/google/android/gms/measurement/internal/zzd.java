...
public class zzd extends zzz {
    static final String anZ = String.valueOf(zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / Constants.MAX_DOWNLOADS).replaceAll("(\\d+)(\\d)(\\d\\d)", "$1.$2.$3");
    private Boolean bU;
    ...
    int zzbtu() {
        return SelectBluetoothToyFragment.HEART_BLINK_INTERVAL_MILLISECONDS;
    }
