...
public class FirebaseInstanceIdService extends zzb {
    ...
    L_0x001d:
        r1 = r0.D();	 Catch:{ IOException -> 0x0035, SecurityException -> 0x0044 }
    ...
    private void zzagl(int i) {
        ((AlarmManager) getSystemService("alarm")).set(3, SystemClock.elapsedRealtime() + ((long) (i * Constants.MAX_DOWNLOADS)), PendingIntent.getBroadcast(this, 0, zzagk(i * 2), 268435456));
    }
