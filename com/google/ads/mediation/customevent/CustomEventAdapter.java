...
public final class CustomEventAdapter implements MediationBannerAdapter<CustomEventExtras, CustomEventServerParameters>, MediationInterstitialAdapter<CustomEventExtras, CustomEventServerParameters> {
    ...
    static final class zza implements CustomEventBannerListener {
        ...
        public void onFailedToReceiveAd() {
            com.google.android.gms.ads.internal.util.client.zzb.zzdd("Custom event adapter called onFailedToReceiveAd.");
            this.zzgw.onFailedToReceiveAd(this.zzgv, ErrorCode.NO_FILL);
        }
    ...
    class zzb implements CustomEventInterstitialListener {
        ...
        final /* synthetic */ CustomEventAdapter zzgy;

        public zzb(CustomEventAdapter customEventAdapter, CustomEventAdapter customEventAdapter2, MediationInterstitialListener mediationInterstitialListener) {
            this.zzgy = customEventAdapter;
            this.zzgv = customEventAdapter2;
        ...
        public void onFailedToReceiveAd() {
            com.google.android.gms.ads.internal.util.client.zzb.zzdd("Custom event adapter called onFailedToReceiveAd.");
            this.zzgx.onFailedToReceiveAd(this.zzgv, ErrorCode.NO_FILL);
        }
        ...
        public void onReceivedAd() {
            com.google.android.gms.ads.internal.util.client.zzb.zzdd("Custom event adapter called onReceivedAd.");
            this.zzgx.onReceivedAd(this.zzgy);
        }
    }
