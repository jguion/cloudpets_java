...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, MediationRewardedVideoAdAdapter, zzmh {
    ...
    final RewardedVideoAdListener zzgf = new RewardedVideoAdListener(this) {
        final /* synthetic */ AbstractAdViewAdapter zzgg;
        ...
        public void onRewarded(RewardItem rewardItem) {
            this.zzgg.zzge.onRewarded(this.zzgg, rewardItem);
        }

        public void onRewardedVideoAdClosed() {
            this.zzgg.zzge.onAdClosed(this.zzgg);
            this.zzgg.zzgd = null;
        }

        public void onRewardedVideoAdFailedToLoad(int i) {
            this.zzgg.zzge.onAdFailedToLoad(this.zzgg, i);
        }

        public void onRewardedVideoAdLeftApplication() {
            this.zzgg.zzge.onAdLeftApplication(this.zzgg);
        }

        public void onRewardedVideoAdLoaded() {
            this.zzgg.zzge.onAdLoaded(this.zzgg);
        }

        public void onRewardedVideoAdOpened() {
            this.zzgg.zzge.onAdOpened(this.zzgg);
        }

        public void onRewardedVideoStarted() {
            this.zzgg.zzge.onVideoStarted(this.zzgg);
        }
    };
    ...
    public Bundle getInterstitialAdapterInfo() {
        return new com.google.android.gms.ads.mediation.MediationAdapter.zza().zzbh(1).zzxg();
    }
