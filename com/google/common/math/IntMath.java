...
public final class IntMath {
    ...
    @VisibleForTesting
    static int[] biggestBinomials = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, DownloaderService.STATUS_PAUSED_BY_APP, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    private static final int[] factorials = new int[]{1, 1, 2, 6, 24, ParseException.CACHE_MISS, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    @VisibleForTesting
    ...
    @VisibleForTesting
    static final int[] powersOf10 = new int[]{1, 10, 100, Constants.MAX_DOWNLOADS, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
