...
class ToyPeripheral$2$2 implements Runnable {
    final /* synthetic */ 2 this$1;
    final /* synthetic */ Error val$error;
    final /* synthetic */ ToyPeripheral val$peripheral;

    ToyPeripheral$2$2(2 this$1, ToyPeripheral toyPeripheral, Error error) {
        this.this$1 = this$1;
    ...
    public void run() {
        ...
        while (it.hasNext()) {
            ((Listener) it.next()).onServicesDiscovered(this.val$peripheral, this.val$error);
        }
    }
}
