...
class ToyPeripheral$2$3 implements Runnable {
    ...
    ToyPeripheral$2$3(2 this$1, ToyPeripheral toyPeripheral, UUID uuid, byte[] bArr, Error error) {
        this.this$1 = this$1;
    ...
    public void run() {
        ...
        while (it.hasNext()) {
            ((Listener) it.next()).onCharacteristicRead(this.val$peripheral, this.val$characteristic, this.val$value, this.val$error);
        }
    }
}
