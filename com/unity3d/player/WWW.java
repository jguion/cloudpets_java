...
class WWW extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            if (!url.getProtocol().equalsIgnoreCase(VoiceMessage.FILE) || url.getHost() == null || url.getHost().length() == 0) {
                int min;
                ...
                if (openConnection instanceof HttpURLConnection) {
                    ...
                    try {
                        ...
                        if (headerFields != null && (min == 301 || min == 302)) {
                            List list = (List) headerFields.get(HttpHeaders.LOCATION);
                ...
                i = (url.getProtocol().equalsIgnoreCase(VoiceMessage.FILE) || url.getProtocol().equalsIgnoreCase("jar")) ? contentLength == 0 ? 32768 : Math.min(contentLength, 32768) : 1428;
                int i3 = 0;
                try {
                    String str;
