...
final class a {
    ...
    private final int[] e() {
        double d = (double) (this.k * Constants.MAX_DOWNLOADS);
        List supportedPreviewFpsRange = this.b.getSupportedPreviewFpsRange();
        if (supportedPreviewFpsRange == null) {
            supportedPreviewFpsRange = new ArrayList();
        }
        int[] iArr = new int[]{this.k * Constants.MAX_DOWNLOADS, this.k * Constants.MAX_DOWNLOADS};
    ...
    L_0x000a:
        r0 = com.unity3d.player.o.a;	 Catch:{ all -> 0x0031 }
        if (r0 == 0) goto L_0x001f;
    L_0x000e:
        r0 = com.unity3d.player.o.h;	 Catch:{ all -> 0x0031 }
