...
final class s implements UncaughtExceptionHandler {
    ...
    final synchronized boolean a() {
        boolean z;
        s defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
