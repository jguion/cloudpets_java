        ...
        if (!this.mInit) {
            ...
            try {
                ...
                if (pi.metaData != null) {
                    ...
                    if (NO_FILE != pi.metaData.getString("mainFilename", NO_FILE)) {
                        resourceFiles = NO_FILE != pi.metaData.getString("patchFilename", NO_FILE) ? new String[]{pi.metaData.getString("mainFilename", NO_FILE), pi.metaData.getString("patchFilename", NO_FILE)} : new String[]{pi.metaData.getString("mainFilename", NO_FILE)};
                    }
                } else {
