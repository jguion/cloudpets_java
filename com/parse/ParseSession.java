...
public class ParseSession extends ParseObject {
    ...
    private static final List<String> READ_ONLY_KEYS = Collections.unmodifiableList(Arrays.asList(new String[]{KEY_SESSION_TOKEN, KEY_CREATED_WITH, KEY_RESTRICTED, "user", KEY_EXPIRES_AT, KEY_INSTALLATION_ID}));
