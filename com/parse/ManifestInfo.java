...
class ManifestInfo {
    ...
    private static boolean hasRequestedPermissions(Context context, String... permissions) {
        ...
        try {
            ...
            if (pi.requestedPermissions != null) {
                z = Arrays.asList(pi.requestedPermissions).containsAll(Arrays.asList(permissions));
            }
        } catch (NameNotFoundException e) {
            PLog.e(TAG, "Couldn't find info about own package", e);
        }
    ...
    private static ManifestCheckResult gcmSupportLevel() {
        ...
        if (!hasRequestedPermissions(context, "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE", "android.permission.WAKE_LOCK", "com.google.android.c2dm.permission.RECEIVE", context.getPackageName() + ".permission.C2D_MESSAGE")) {
            return ManifestCheckResult.MISSING_REQUIRED_DECLARATIONS;
        }
        String packageName = context.getPackageName();
